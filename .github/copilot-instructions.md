...
- If changes were made anywhere under skills/startup-india-goat/, confirm the install copy has been refreshed with:

npx skills add . -g -y

## Vendor exclusion zone

- Never suggest changes to skills/startup-india-goat/scripts/lib/vendor/.
- Treat skills/startup-india-goat/scripts/lib/vendor/ as a no-touch zone.

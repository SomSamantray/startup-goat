...
Startup India GOAT also keeps credentials out of reports; inspect `skills/startup-india-goat/scripts/lib/env.py` and sanitized fixtures when changing source access.
